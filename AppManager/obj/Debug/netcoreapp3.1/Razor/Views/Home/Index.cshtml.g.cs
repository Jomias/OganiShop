#pragma checksum "D:\devMaster\Net\AppManager\AppManager\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9c0f3a7c14f415d11978e0464df1df9abff46e42"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9c0f3a7c14f415d11978e0464df1df9abff46e42", @"/Views/Home/Index.cshtml")]
    ...
    #nullable disable
    {
        ...
        {
#nullable restore
#line 1 "D:\devMaster\Net\AppManager\AppManager\Views\Home\Index.cshtml"
            ...
            <div class=""col-lg-9"">
                <div class=""hero__search"">
                    <div class=""hero__search__form"">
                        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "9c0f3a7c14f415d11978e0464df1df9abff46e424421", async() => {
                WriteLiteral(@"
        ...
        <div class=""row"">
            <div class=""col-lg-4 col-md-6"">
                <div class=""latest-product__text"">
                    ...
                    <div");
            WriteLiteral(@" class=""latest-product__slider owl-carousel"" id=""latest-product1"">
                    </div>
                </div>
            </div>
            <div class=""col-lg-4 col-md-6"">
...
<section class=""from-blog spad"">
    <div class=""container"">
        <div class=""row"">
            <div class=""col-lg-12"">
                <div class=""sectio");
            WriteLiteral("n-title from-blog__title\">\r\n                    <h2>From The Blog</h2>\r\n                </div>\r\n            </div>\r\n        </div>\r\n        <div class=\"row\" id=\"blog\">\r\n        </div>\r\n    </div>\r\n</section>\r\n\r\n");
    ...
    $(document).ready(function () {
        $.ajax({
            ...
            success: function (data) {
                data.forEach(function (item, index) {
                   ");
                WriteLiteral(@" let row = `<div class=""col-lg-3"">
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                data.forEach(function (item, index) {
                    ...
                    let z = `                        
                            <a href=""/ProductDetail/Index?id=${item.id}"" class=""latest-product__item"">
                                <div class=""latest-product__item__pic"">
                                    <img src=""${item.avatar}"" alt="""">
                                </div>
 ");
                WriteLiteral(@"                               <div class=""latest-product__item__text"">
                                    <h6>${item.name}</h6>
                                    <span>$${money}</span>
                                </div>
                            </a>`;
                ...
                if (data.length % 3 != 0) {
                    row += `</div>`;
                    $('#latest-product1').owlCarousel().trigger('add.owl.carousel', row);
                    $('#latest-product2').owlCarousel().trigg");
                WriteLiteral(@"er('add.owl.carousel', row);
                    $('#latest-product3').owlCarousel().trigger('add.owl.carousel', row);
                }
    ...
    $.ajax({
        ...
        success: function (data) {
           ...
           ");
                WriteLiteral(@"                                 <img src=""${item.blogAvatarFilePath}"" alt="""" style=""width: 360px; height: 260px"">
                                        </div>
  ...
  ");
                WriteLiteral(@"                                              <li><a href=""#"" class=""add-to-cart""><i class=""fa fa-shopping-cart""></i></a></li>
                                            </ul>
                                        </div>
                                        <div class=""featured__item__text"">
                                            <h6><a href=""/ProductDetail/Index?id=${itm.id}"">${itm.name}</a></h6>
                                            <h5>$${price}</h5>
                                        </div>
                                    </div>
                                </div>`
